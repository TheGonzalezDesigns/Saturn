pub mod saturn {
use anyhow::Result;
use crate::chat_completions::providers::{openai::openai::openai, gemini::gemini::gemini, perplexity::perplexity::perplexity};
    ...
    async fn test_saturn_bot() {
        ...
        match saturn(query.clone()).await {
            Ok(response) => {
                ...
                assert!(!response.is_empty(), "Saturn bot should return a valid response.");
            }
